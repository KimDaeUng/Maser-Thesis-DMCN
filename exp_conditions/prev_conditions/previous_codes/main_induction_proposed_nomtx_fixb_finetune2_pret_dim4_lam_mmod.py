...
import random
import numpy as np
from model_induction_proposed_nomtx_fixb_ftune2nd_pret_mmod import DMRInduction
...
def dev(episode):
    ...
    model.memory_cls_vector_backup = copy.deepcopy(model.memory_cls_vector)
    ...
    model.memory_cls_vector = model.memory_cls_vector_backup
