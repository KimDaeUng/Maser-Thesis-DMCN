...
import random
import numpy as np
from model_induction_proposed_nsdm_lambda import DMRInduction
...
if __name__ == "__main__":
    ...
    config.read("config_2_proposed_comp_dim_ndsm_lambda.ini")
    ...
    # config.read("config_2_proposed_comp_dim_12.ini")
