...
import random
import numpy as np
from model_induction_proposed_fix_embedding import DMRInduction
...
if __name__ == "__main__":
    ...
    config.read("config_2_proposed_fix_embedding.ini")
    ...
    # os.environ['HTTPS_PROXY'] = 'http://210.94.194.121:3128/'
