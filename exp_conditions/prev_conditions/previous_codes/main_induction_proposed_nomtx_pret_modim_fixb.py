...
import random
import numpy as np
from model_induction_proposed_nomtx_pret_modim_fixb import DMRInduction
...
if __name__ == "__main__":
    ...
    # config.read("config_2_proposed_comp_nomtx_pret_modim.ini")
    config.read("config_2_proposed_comp_nomtx_pret_modim_fixb.ini")
