...
import random
import numpy as np
from model_induction_proposed_nomtx_fixb_ftune2nd_pret_nos import DMRInduction
...
if __name__ == "__main__":
    ...
    config.read("config_2_proposed_comp_nomtx_fixb_ftune2_pret_dim4_lam_nos.ini")
