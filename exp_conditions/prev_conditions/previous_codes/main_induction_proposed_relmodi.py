...
import random
import numpy as np
from model_induction_proposed_relmodi import DMRInduction
...
def main():
    ...
    if continue_train == 1:
        ckpt_path = os.path.join(config['Log']['ckpt_path'], '*') 
...
if __name__ == "__main__":
    ...
    # config.read("config_2_proposed_comp_reldim100.ini")
    # config.read("config_2_proposed_comp_reldim12.ini")
    # config.read("config_2_proposed_comp_reldim.ini")
    # config.read("config_2_proposed_comp_mmodi.ini")
    config.read("config_2_proposed_comp_relmodi.ini")
    # config.read("config_2_proposed_comp_dim_more.ini")
    print(config['Log']['tag'])
    ...
    relation_out_dim = int(config['Model']['relation_out_dim'])
    ...
    model = DMRInduction(n_class=n_class,
                             ...
                             top_k=top_k,
                             comp_dim=comp_dim,
                             relation_out_dim=relation_out_dim,
                             device=device)
    # wandb.watch(model)
