...
import random
import numpy as np
from model_induction_proposed_nomtx_fixb_ftune2nd import DMRInduction
...
def main():
    ...
    if continue_train == 1:
        ...
        print("epi : ", epi)
        latest_file = os.path.join(config['Log']['ckpt_path'], "S-5_Q-27_LR-1e-5_Tmp-1_TopK-10_NRouting-3_NCapsule2_CompDim-8_NLastLayer-2_TAG-induction_2_proposed_fixb_ftune2_Epi-{}.h5".format(epi)) 
...
if __name__ == "__main__":
    ...
    config.read("config_2_proposed_comp_nomtx_fixb_ftune2_fortest.ini")
